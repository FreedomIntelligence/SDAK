...
from accelerate import Accelerator
from transformers import AutoTokenizer, AutoModelForCausalLM, AutoModel, LlamaTokenizer,LlamaForCausalLM,AutoConfig
...
class BaseWorker():
    ...
    def __post_init__(self):
        ...
        # print('self.instruction_template')
        # print(self.instruction_template)
