...
def calculate_class_accuracy(all_subject_dict, right_class_dict):
    ...
    for key in all_subject_dict:
        accuracy_class_dict[key] = calculate_accuracy(
            all_subject_dict[key], right_class_dict[key]
        )
    ...
    for key in all_subject_type_dict:
        for inner_key in all_subject_type_dict[key]:
            accuracy_class_type_dict[key][inner_key] = calculate_accuracy(
                all_subject_type_dict[key][inner_key],
...
def scorer(args):
    ...
    accuracy_subject_type_dict = calculate_class_type_accuracy(
        all_subject_type, right_class_type
    )
